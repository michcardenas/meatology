...
<style>
    ...
    .btn-primary {
        background: linear-gradient(135deg, #2d5016, #011904);
        color: #ffffff;
        border: none;
        padding: 15px 35px;
        font-size: 1.1rem;
...
<!-- Sección de Productos Destacados - FONDO BLANCO -->
<section class="py-5" style="background-color: #f8f9fa;">
    <div class="container">
        <!-- Encabezado -->
        <div class="row mb-5 text-center">
            <div class="col">
                <span class="section-badge bg-success text-white px-3 py-1 rounded-pill">🔥 Monthly Selection</span>
                <h2 class="section-title mt-3" style="color: #011904;">Featured Cuts of the Month</h2>
                <p class="section-description" style="color: #2d5016;">
...
<!-- Call to Action: View All Products - VERSIÓN CLARA -->
<section class="py-5 text-center" style="background: linear-gradient(135deg, #e8f5e9 40%, #ffffff 100%);">
    <div class="container">
        <h2 class="mb-4 fw-bold" style="color: #011904;">Want to explore our full selection?</h2>
        <p class="lead" style="color: #2d5016;">Discover all our premium cuts and find the perfect choice for your next culinary adventure.</p>
        <a href="{{ route('shop.index') }}" class="btn btn-lg text-white fw-semibold mt-3 shadow-sm" style="background: #2d5016;">
            <i class="fas fa-store me-2"></i> View All Products
        </a>
    </div>
</section>

<!-- Category Showcase - FONDO CLARO -->
<section class="py-5" style="background: linear-gradient(135deg, #ffffff 50%, #e8f5e9 100%);">
    <div class="container">
        <div class="row text-center mb-5">
            <div class="col">
                <span class="section-badge bg-success text-white px-3 py-1 rounded-pill">🧾 Categories</span>
                <h2 class="section-title mt-3" style="color: #011904;">Browse by Category</h2>
                <p class="section-description" style="color: #2d5016;">Select the perfect cut based on your preference or culinary needs.</p>
                <div class="section-divider mx-auto bg-success" style="height: 3px; width: 80px;"></div>
            </div>
        </div>
        ...
        <div class="row g-4">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="card h-100 shadow border-0" style="background-color: #ffffff;">
