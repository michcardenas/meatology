                    ...
                    <form action="{{ route('admin.discounts.store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('descripcion') is-invalid @enderror" 
                                      ...
                                      placeholder="Descripción opcional del descuento">{{ old('descripcion') }}</textarea>
                            @error('descripcion')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    <input type="number" class="form-control @error('porcentaje') is-invalid @enderror" 
                                           id="porcentaje" name="porcentaje" value="{{ old('porcentaje') }}" 
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" class="form-control @error('numero_descuentos') is-invalid @enderror" 
                                       id="numero_descuentos" name="numero_descuentos" value="{{ old('numero_descuentos') }}" 
                        ...
                        <div class="mb-3">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="tipo_descuento" 
                                               id="tipo_global" value="global" {{ old('tipo_descuento') === 'global' ? 'checked' : '' }}>
                                ...
                                <div class="col-md-4">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="tipo_descuento" 
                                               id="tipo_categoria" value="categoria" {{ old('tipo_descuento') === 'categoria' ? 'checked' : '' }}>
                                ...
                                <div class="col-md-4">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="tipo_descuento" 
                                               id="tipo_producto" value="producto" {{ old('tipo_descuento') === 'producto' ? 'checked' : '' }}>
                        ...
                        <div class="mb-3" id="producto_select" style="display: none;">
                            ...
                            <select class="form-select @error('id_producto') is-invalid @enderror" 
                                ...
                                @foreach($products as $product)
                                    <option value="{{ $product->id }}" {{ old('id_producto') == $product->id ? 'selected' : '' }}>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Ejecutar al cargar la página (para old values)
    toggleFields();
